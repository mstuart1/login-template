This template is for non-nextJS react apps to provide secure authentication and authorization with protected routes, httponly jwt cookies, node express backend endpoints and session management.
